export const intentScopeDataset = [
  {
  ...
  },
  {
    ...
    extendedIntent: [],
    message:
      "If you need environment variables, use the existing configuration system.",
    expectNewIntent: true,
  },
  {
    originalIntent: "Build a todo list web application",
  ...
  },
  {
    ...
    extendedIntent: [],
    message:
      "Don't use any or unknown, don't read .env files, and keep the code simple.",
    expectNewIntent: true,
  },
  {
    originalIntent: "Build a todo list web application",
    extendedIntent: [],
    message:
      "Build the UI, but don't modify the existing API and don't install new dependencies.",
    expectNewIntent: true,
  },
  {
    originalIntent: "Build a todo list web application",
  ...
  },
  {
    ...
    extendedIntent: [],
    message:
      "Use the existing design system and don't introduce custom UI components.",
    expectNewIntent: true,
  },
  {
    originalIntent: "Build a todo list web application",
